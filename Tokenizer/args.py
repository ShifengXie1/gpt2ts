...
parser.add_argument("--vq_model", type=str, default='GPT2ClusterVQ', choices=['GPT2ClusterVQ'])
...
parser.add_argument("--gpt2_cluster_path", type=str, default=None)
parser.add_argument("--gpt2_cluster_iters", type=int, default=25)
parser.add_argument("--cluster_tau", type=float, default=0.2)
parser.add_argument("--cluster_cosine", type=int, default=1)
...
args.gpt_local_files_only = bool(args.gpt_local_files_only)
args.cluster_cosine = bool(args.cluster_cosine)
